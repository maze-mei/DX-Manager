...
DX Manager is an independently developed utility.
...
The Windows distribution may also include Android Debug Bridge (ADB),
FFmpeg libraries, SDL, and libusb as runtime dependencies of DX Manager or
scrcpy. These components remain subject to their respective licenses and
notices.

Before public redistribution, verify that the exact binary versions in the
release package may be redistributed and include every license file required
by those versions.
