...
DX Manager가 DeX 또는 단일창 사용 중 적용한 **충전 중 화면 켜짐** 설정은
...
- 휴대폰의 **개발자 옵션 → 충전 중 화면 켜짐** 항목을 직접 끕니다.
- 같은 휴대폰을 DX Manager에 다시 연결한 뒤 정상적인 방법으로 종료합니다.

이 설정은 배터리만 사용하는 동안 화면을 강제로 켜 두는 기능은 아니지만,
USB 또는 충전기에 연결했을 때 화면이 자동으로 꺼지지 않게 할 수 있습니다.
